...
## Enabled IOMMMU support in Proxmox
...
* Follow the steps in the [Creating the Windows VM](https://github.com/isc30/ryzen-7000-series-proxmox?tab=readme-ov-file#creating-the-windows-vm) section of this document
# References
